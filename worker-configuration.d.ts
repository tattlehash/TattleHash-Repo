/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c428570268646fb7ecda4f655464254a)
// Runtime types generated with workerd@1.20251011.0 2025-11-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AnchorLock";
	}
	interface Env {
		...
		routes: [{"pattern":"api.tattlehash.com/*","zone_name":"tattlehash.com"}];
		AnchorLock: DurableObjectNamespace<import("./src/worker").AnchorLock>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TATTLEHASH_BRAND_NAME" | "ANCHOR_MODE" | "WEB3_RPC_URL_POLYGON" | "OPENAI_MODEL" | "NODE_ENV" | "RPC_ETH_MAIN" | "RPC_BASE_MAIN" | "POLICY_VERSION" | "QUEUE_PREFIX" | "RECEIPT_PREFIX" | "routes">> {}
}
